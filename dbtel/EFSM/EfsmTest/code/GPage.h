...
#include <Forms.hpp>                                                         enum GShape {sNone, sSelectRect, sRoundRect, sArrow, sSelectArrow};
...
public:		// User declarations
    __fastcall TGPageForm(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TGPageForm *GPageForm;
//---------------------------------------------------------------------------
#endif
