...
U32 TI_064_AV_Test()
{
	TS_Msg tsMsg = {TUNER1, true, 183000000, QAM64, {0x8c0, 0x8c0, 0x8c1}, ROUTE_TO_MCARD};
//	TS_Msg tsMsg = {TUNER1, true, 183000000, QAM64, {0x8c0, 0x8c0, 0x8c1}, BYPASS_MCARD};
	U32 lError = 0;
...
// When did the single step test, the probe "CODE RUNNER" will disable interrupt.
	...
	lError = TI_064_AV_Test();
	if (timerISR_Enabled) {
		lib.clock.EnableTimerInterrupt();
	}
#else
	U32 (*pf)() = &TI_064_AV_Test;
