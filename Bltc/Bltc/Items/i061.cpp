...
U32 TI_061_AV_Test()
{
	TS_Msg tsMsg1 = {TUNER1, true, 85000000, QAM256, {0x800, 0x800, 0x801}, BYPASS_MCARD};
	TS_Msg tsMsg2 = {TUNER2, true, 183000000, QAM64, {0x8c0, 0x8c0, 0x801}, BYPASS_MCARD};
	U32 lError = 0;
...
// When did the single step test, the probe "CODE RUNNER" will disable interrupt.
	...
	lError = TI_061_AV_Test();
	if (timerISR_Enabled) {
		lib.clock.EnableTimerInterrupt();
	}
#else
	U32 (*pf)() = &TI_061_AV_Test;
